function Start()
    local ok, err = pcall(function()
        local CONFIG = {
            name = "attack",
            frames = {
                "Textures/attack_1.png",
                "Textures/attack_2.png",
                "Textures/attack_3.png",
                "Textures/attack_4.png",
                "Textures/attack_5.png",
                "Textures/attack_6.png",
            },
            fps = 10,
            output_dir = "/workspace/assets/Spines/attack",
        }
        ...
        local skeleton = {
            skeleton = { hash = " ", spine = "3.8.75", x = 0, y = 0, width = frameW, height = frameH },
            bones = { { name = "root" } },
        ...
        print("[spine] DONE - 6 frames packed to " .. CONFIG.output_dir)
    end)
    if not ok then
